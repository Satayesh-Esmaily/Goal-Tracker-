...
export default function ActiveGoalsSection({ goals, onAddProgress, onTogglePause, onDelete }) {
  ...
  return (
    <SectionCard
      ...
      action={<Chip size="small" label={t("dashboard.itemsCount", { count: goals.length })} />}
    >
      {goals.length === 0 ? (
